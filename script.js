...
const firebaseConfig = {
    apiKey: "AIzaSyBdLFCF6sfBGVAn8Z5_NYspXN2KcwqGVRk",
    ...
    appId: "1:438781657853:web:073be09c4ea0dae73af494"
};
...
function buildMenu() {
    ...
    if (isAdminMode) {
        ...
        panel.innerHTML = `
            ...
            <div class="action-item" id="logoutAction"><i class="fas fa-sign-out-alt"></i> გამოსვლა</div>
        `;
        document.getElementById("findAddressAction").onclick = () => { setAddPinMode(true);
