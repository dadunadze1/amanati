...
const state = {
  ...
  adminMapFinanceTapTimes: [],
  courierMapRotationBound: false,
  courierMapRotationActive: false,
  courierMapRotationStartAngle: 0,
  courierMapRotationBaseBearing: 0,
  courierMapBearing: 0,
  currentUser: null,
